...
export async function POST(req: NextRequest, res: NextResponse) {
  try {
    ...
    const data = {
      ...
      subject: `Application for ${fields.categoryTitle} - ${fields.referenceID} - ${fields.applicantName} - ${fields.whatAppNo}`,
  ...
  <b> UID No:</b>  ${fields.uidNumber} <br /> <br />
  <b> PO-Box Number: </b>  ${fields.p0BoxNumber} <br /> <br />
  <b> Emirates: </b>  ${fields.emirates} <br /> <br />
