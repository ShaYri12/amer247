...
const ApplyForm = ({ categoryTitle, serviceName, price }: Props) => {
  ...
  const referenceID = "AMR" + generateReferenceId();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await axios
      ...
      .then(async (response: { data: { data: { id: string | Blob } } }) => {
        formData.append("ref", "api::amer-service.amer-service");
  ...
  const changeToFormData = (
    ...
    formData.append("insideOrOutside", formdata.insideOrOutside);
      ...
      >
        ...
        <form action="" className="py-5 space-y-2">
          ...
          <CustomSelectInput
            ...
            id="insideOrOutside"
            onChange={handleChange}
            value={formdata.insideOrOutside}
            options={insideOutside}
          />
